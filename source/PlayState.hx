...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['Aww...', 0.4], //From 20% to 39%
		['Eh.', 0.5], //From 40% to 49%
		['Kinda bad.', 0.6], //From 50% to 59%
		['You can do it!', 0.69], //From 60% to 68%
		['Nice!', 0.7], //69%
		['Great!', 0.8], //From 70% to 79%
		['Not bad!', 0.9], //From 80% to 89%
		['Keep it up!', 1], //From 90% to 99%
		['Very great!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
				...
				if(!ClientPrefs.lowQuality) {
					...
					add(stageCurtains);
                         ...
                         case 'PC_background':
                                ...
                                defaultCamZoom = 0.85;
                                curStage = 'redbg';
                                var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('TechnologicallyCool/PCandCubeBG'));
